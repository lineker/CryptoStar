...
contract("StarNotary", accounts => {
    ...
    it('lets user1 get the funds after the sale', async() => {
        ...
        console.log("before: " + balanceOfUser1BeforeTransaction);
        console.log("after: " + balanceOfUser1BeforeTransaction);
    ...
    it('lets 2 users exchange stars', async() => {
        ...
        await instance.putStarUpForSale(tokenId2, starPrice, {from: user2});
        // 2. Call the exchangeStars functions implemented in the Smart Contract
        await instance.exchangeStars(tokenId1, tokenId2, {from: user2});
